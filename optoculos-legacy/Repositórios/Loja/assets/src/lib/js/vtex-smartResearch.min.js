...
jQuery.fn.vtexSmartResearch = function(opts) {
    ...
    var defaults = {
        ...
        returnTopText: '<i class="ico-arrow"></i><span>Voltar<br/>ao topo</span>', // Mensagem de "retornar ao topo"
    ...
    var fn = {
        ...
        scrollToTop: function() {
            ...
            if (elem.length < 1) {
                elem = jQuery('<div id="returnToTop"><a href="#">' + options.returnTopText + '</a></div>');
                body.append(elem);
            }
